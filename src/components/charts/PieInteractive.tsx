  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-sm border">
      ...
      <ResponsiveContainer width="100%" height={height}>
        <PieChart>
          <Pie
            ...
            cx="50%" cy="50%" innerRadius={innerRadius} outerRadius={outerRadius} dataKey="value" activeIndex={activeIndex}
      ...
      <div className="flex flex-wrap justify-center gap-4 mt-4">
        {data.map((d, i) => (
          <button key={d.name} className={`flex items-center gap-2 text-xs px-2 py-1 rounded-md border ${activeIndex === i ? 'border-blue-500 text-blue-700' : 'border-gray-200 text-gray-600'}`} onMouseEnter={() => setActiveIndex(i)}>
